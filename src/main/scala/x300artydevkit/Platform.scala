...
//-------------------------------------------------------------------------
// X300ArtyDevKitPlatformIO
//-------------------------------------------------------------------------

class X300ArtyDevKitPlatformIO(implicit val p: Parameters) extends Bundle {
  val pins = new Bundle {
...
//-------------------------------------------------------------------------
// X300ArtyDevKitPlatform
//-------------------------------------------------------------------------

class X300ArtyDevKitPlatform(implicit val p: Parameters) extends Module {
  val interface = new X300ArtyDevKitSystem
  val sys = Module(LazyModule(interface).module)
  val io = new X300ArtyDevKitPlatformIO
